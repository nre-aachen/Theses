	\chapter{Results}\label{cha:results}
		...
		\end{figure}
		Results from this third model show that in contrast to the reservoir thickness, seal thickness is a primary and decisive factor for trap volume. Using likelihoods which favor a thick reservoir, might only a thin seal of about 50 m thickness, leakage due to  
