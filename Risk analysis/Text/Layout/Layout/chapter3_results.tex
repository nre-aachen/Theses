	\chapter{Results}\label{cha:results}
		...
		\begin{table}[h]
			...
			\begin{tabular}{lrr} 
				...
				\bottomrule
			\end{tabular}
			\caption{Layer thickness likelihoods determined by normal distributions as used for posterior model IV.}
		...
		\begin{table}[h]
			...
			\begin{tabular}{lrr} 
				...
				\bottomrule
			\end{tabular}
			\caption{SSF-likelihood determined by normal distributions as used for posterior model V.}
