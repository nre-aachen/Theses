	\chapter{Results}\label{cha:results}
		...
		\end{table}
		For the simulation of this first posterior model, thickness likelihoods for the three central layers were defined (see Table \ref{tab:ML1_likelihoods}).
		\begin{figure}[p!]
			\centering
