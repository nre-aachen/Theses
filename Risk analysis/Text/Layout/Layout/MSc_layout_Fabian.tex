...
% Abstract
	\nonumchap{Abstract}
Bayesian methods are an intuitive approach to inference and subsequent decision-making, relatable to a wide spectrum of problems. Hydrocarbon exploration and production is a high-risk, high-reward sector in which good decision-making is indispensable. However, actors in this field are faced by numerous uncertainties that have to be considered. Structural geological modeling is of central importance for the estimation of uncertain hydrocarbon accumulations in potential reservoirs. Recent developments have shown, that such modeling can be regarded as a Bayesian inference problem. This allows for the incorporation of additional geological information as likelihood functions in a probabilistic framework and a consequent reduction of model uncertainties. 
