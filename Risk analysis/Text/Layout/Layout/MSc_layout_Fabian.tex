...
% Make a hell of a lot of title pages
    \maketitle
%
\includepdf[pages={1}]{eidesstattliche_erklaerung.pdf}
...
% Acknowledgements
    ...
    First and foremost, I wish to express my greatest thanks to my supervisor Miguel de la Varga, for continually supporting and motivating me to pursue a better understanding of computational geosciences and probabilistic methods.
    
    I also want to thank all of my friends and fellow researchers
    \vspace*{15mm}
