...
\usepackage{grffile}
\mode<presentation>{\usetheme{RWTH}}
...
\title{\huge CCS Summer School in Oslo}
\author{d \\ Marco van Veen}
\institute[RWTH Aachen University]{Computational Geoscience and Reservoir Engineering, RWTH Aachen University, Aachen, Germany}
